...
categories: Projects
excerpt: Our work contributes to building a mechine learning model to predict a health score for an individual, for this study we used health data to determine the like hood if someone can have diabetes in near future or not.
我们通过搜集个人基本信息，运动饮食等行为数据，使用机器学习模型构建个人身体状况评分模型，得到相关疾病的发生概率。
---
...
someone can have diabetes in near future or not.The following content are from the final report.                                                                                                                                                        
...
<center>
<img src="https://i.ibb.co/GWvGyHp/1.png" width="96%"/>
</center>
